...
#define OVER_TEMP_LEVEL                         10 //upper limit for temp that causes alarm/high otemp state
...
void OutputsInit() {
  //should be declared an output
    displayInit(DISPLAY_CONNECTION_I2C_PCF8574_IO_EXPANDER); //display init needs to know what mode you running the LCD in, 4bit or 8 bit or other, had to change to exapnder mode to fix blank display issue
