...
extern DigitalOut sirenPin; //put external declaration in here to prevent undeclaration or re-declaration from happening
...
/*the header files for now only consist of prototyping of functions all other declarations and
all other declarations, pin assignments etc are to go into the cpp file*/
