...
#define NUMBER_OF_KEYS                           4 //size of password array
...
#define EVENT_MAX_STORAGE                      100 //used for an array of structs to access specific data stored in each one
#define EVENT_NAME_MAX_LENGTH                   14 //how long can an event name be
